...
const CREATE_WIRE_ACCOUNT = getApiUrl("/v1/banks/wires");
const GET_WIRE_ACC_STATUS_WITH_ID_PARAMS = getApiUrl("/v1/businessAccount/banks/wires");
const GET_CIRCLE_ACCOUNT_PRAMS = getApiUrl("/v1/banks/wires");
...
const CREATE_CIRCLE_CHAIN_WALLET = getApiUrl("/v1/wallets");
const CREATE_CIRCLE_CHAIN_ADDRESS_WALLET_ID_PARAMS = getApiUrl("/v1/wallets"); //wallet id/addresses
const GET_CIRCLE_CHAIN_WALLET_BALANCE_WALLETID_PARAMS = getApiUrl("/v1/wallets"); //wallet id

const CREATE_PAYOUT_WIRE_CHAIN = getApiUrl("/v1/payouts");
const GET_WIRE_CHIAN_PAYOUT_STATUS_WITH_ID_PARAMS = getApiUrl("/v1/payouts");



export {
    GET_WIRE_CHIAN_PAYOUT_STATUS_WITH_ID_PARAMS,
    CREATE_PAYOUT_WIRE_CHAIN,
    GET_CIRCLE_CHAIN_WALLET_BALANCE_WALLETID_PARAMS,
    CREATE_CIRCLE_CHAIN_ADDRESS_WALLET_ID_PARAMS,
    CREATE_CIRCLE_CHAIN_WALLET,
